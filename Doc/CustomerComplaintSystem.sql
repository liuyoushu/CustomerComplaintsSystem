...
/* Created on:     2014/5/15 22:59:12                           */
/*==============================================================*/


if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('Accounts_RolePermissions') and o.name = 'FK_ACCOUNTS_REFERENCE_Roles2')
alter table Accounts_RolePermissions
   drop constraint FK_ACCOUNTS_REFERENCE_Roles2
go

if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('Accounts_RolePermissions') and o.name = 'FK_ACCOUNTS_REFERENCE_Permission')
alter table Accounts_RolePermissions
   drop constraint FK_ACCOUNTS_REFERENCE_Permission
go

if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('Accounts_UserRoles') and o.name = 'FK_ACCOUNTS_REFERENCE_Users')
alter table Accounts_UserRoles
   drop constraint FK_ACCOUNTS_REFERENCE_Users
go

if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('Accounts_UserRoles') and o.name = 'FK_ACCOUNTS_REFERENCE_Roles')
alter table Accounts_UserRoles
   drop constraint FK_ACCOUNTS_REFERENCE_Roles
go

if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('Accounts_Users') and o.name = 'FK_ACCOUNTS_REFERENCE_STAFF')
alter table Accounts_Users
   drop constraint FK_ACCOUNTS_REFERENCE_STAFF
go
...
if exists (select 1
            from  sysobjects
           where  id = object_id('Accounts_Permissions')
            and   type = 'U')
...
if exists (select 1
            from  sysobjects
           where  id = object_id('Accounts_RolePermissions')
            and   type = 'U')
...
if exists (select 1
            from  sysobjects
           where  id = object_id('Accounts_Roles')
            and   type = 'U')
...
if exists (select 1
            from  sysobjects
           where  id = object_id('Accounts_UserRoles')
            and   type = 'U')
...
if exists (select 1
            from  sysobjects
           where  id = object_id('Accounts_Users')
            and   type = 'U')
...
create table Accounts_Permissions (
   ...
   constraint PK_ACCOUNTS_PERMISSIONS primary key (PermissionID)
)
go
...
create table Accounts_Roles (
   RoleID               int                  not null,
   Description          nvarchar(255)        null,
   constraint PK_ACCOUNTS_ROLES primary key (RoleID)
)
go
...
create table Accounts_Users (
   ...
   constraint PK_ACCOUNTS_USERS primary key (UserID)
)
go
...
alter table Accounts_RolePermissions
   add constraint FK_ACCOUNTS_REFERENCE_Roles2 foreign key (RoleID)
      references Accounts_Roles (RoleID)
go

alter table Accounts_RolePermissions
   add constraint FK_ACCOUNTS_REFERENCE_Permission foreign key (PermissionID)
      references Accounts_Permissions (PermissionID)
go

alter table Accounts_UserRoles
   add constraint FK_ACCOUNTS_REFERENCE_Users foreign key (UserID)
      references Accounts_Users (UserID)
go

alter table Accounts_UserRoles
   add constraint FK_ACCOUNTS_REFERENCE_Roles foreign key (RoleID)
      references Accounts_Roles (RoleID)
go

alter table Accounts_Users
   add constraint FK_ACCOUNTS_REFERENCE_STAFF foreign key (Stf_ID)
